...
**Skill version: 0.4.8** | **CLI version: @fluxa-pay/fluxa-wallet@0.4.8** — **MUST** install or update to the latest CLI version before use.
...
```bash
npm install -g @fluxa-pay/fluxa-wallet@0.4.8
```
